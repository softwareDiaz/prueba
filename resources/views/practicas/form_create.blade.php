<!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="/practicas">practicas</li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Crear practicas</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="practicaCreateForm" role="form" novalidate>
                  ...
                  <div class="callout callout-danger" ng-show="errors">
                    ...
                    <div class="form-group" ng-class="{true: 'has-error'}[ practicaCreateForm.edad.$error.required && practicaCreateForm.$submitted || practicaCreateForm.edad.$dirty && practicaCreateForm.edad.$invalid]">
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" ng-click="createpractica()">Crear</button>

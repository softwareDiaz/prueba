(function(){
    angular.module('crud.services.services',[])
        .factory('crudServiceServices',['$http', '$q','$location', function($http, $q,$location){
            ...
            function numeracion(uri){
                var deferred = $q.defer();
                //alert(val);
                $http.get('/api/'+uri+'/numero')
                    .success(function (data) {
                        deferred.resolve(data);
                    });
